function stimERPs_withBootstrap_v4(PatientID,metric,yMin,yMax,plotWindow,specWindow)
    ...
    load(fullfile(patientdatapath,'movie_out_structs','Sufficiency Stim','out_movie_100Hz_with.mat'),'out_movie'); %For cleaned RSA data
            ...
            for k = 1:length(thisCurrentSource_targets) %Sort by target electrode
                ...
                for l = 1:length(thisCurrentSourceTarget_frequencies) %Sort by frequency
                    ...
                    switch metric
                        ...
                        case 'RSA'
                            [sitemn mn_boot std_boot sitemnboot t std_boot_pos std_boot_neg] = get_stim_mean_nulldist_RSA(out_movie_thisBin, out_movie,Nboot,plotWindow,specWindow);
                    end
